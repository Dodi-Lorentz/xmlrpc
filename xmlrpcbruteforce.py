...
# Author:   Dodi Lorentz
# Date:     2020-Juni-11
# Email: iamserver87@gmail.com
# WhatsApp:  https://api.whatsapp.com/send?phone=6283141895141&text=hi
...
def verify(url): ## verify if target is vulnerable or not
    ...
    if "wp.getUsersBlogs" in r.text:
        ...
        print("Please report any incorrect results on GitHuB or PM on WhatsApp")
        sys.exit(0)
...
def main(argv):
  if len(argv) < 3:
    print(bcolors.OKGREEN + "Created by: Dodi Lorentz\nVersion: 1.0"+ bcolors.ENDC)
